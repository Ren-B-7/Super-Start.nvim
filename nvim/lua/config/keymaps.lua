...
set("n", "<leader>fb", require("telescope.builtin").buffers, { desc = "List open buffers" })
...
-- harpoon keymaps
set("n", "<leader>hz", ui.toggle_quick_menu, { desc = "Toggle Harpoon quick menu" })
set("n", "<leader>ha", mark.add_file, { desc = "Add file to Harpoon" })
set("n", "<leader>hj", ui.nav_next, { desc = "Navigate to next Harpoon file" })
set("n", "<leader>hk", ui.nav_prev, { desc = "Navigate to previous Harpoon file" })
